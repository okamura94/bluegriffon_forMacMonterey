...
public:
    ...
    bool EnsureInitialized()
    {
        ...
        printf("--------GLContextProviderCGL.mm EnsureInitialized() MacOS Version major: %d minor: %d\n", major, minor);
        printf("--------GLContextProviderCGL.mm EnsureInitialized() OpenGL Library Path & Library Name: %s\n", kOpenGlLibPathName);
        ...
        if (!mOGLLibrary) {
            ...
            mOGLLibrary = PR_LoadLibrary(kOpenGlLibPathName);
            if (!mOGLLibrary) {
