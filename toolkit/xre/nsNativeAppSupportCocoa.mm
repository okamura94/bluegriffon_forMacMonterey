...
//    NSLog(@"nsNativeAppSupportCocoa major  / %d\n",(int)major);
//    NSLog(@"nsNativeAppSupportCocoa minor  / %d\n",(int)minor);
//    NSLog(@"nsNativeAppSupportCocoa bugfix / %d\n",(int)bugfix);
// Change 2022.11 Exec MacOS Version check pass
//  if (major < 10 || minor < 6) {
