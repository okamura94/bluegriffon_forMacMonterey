...
// [Big Sur Support] 4-Lines Commnts -----------------------------------------------------
...
{
// [Big Sur Support] 5-Lines Comments and 12-Line add ------------------------------------
...
ComputeSystemSupportsVibrancy()
{
  ...
  if (NSClassFromString(@"NSAppearance")) {
     printf("--------VibrancyManager.mm ComputeSystemSupportsVibrancy() NSClassFromString(@NSAppearance): true\n");
  } else {
     printf("--------VibrancyManager.mm ComputeSystemSupportsVibrancy() NSClassFromString(@NSAppearance): false\n");
  }

  if (NSClassFromString(@"NSVisualEffectView")) {
     printf("--------VibrancyManager.mm ComputeSystemSupportsVibrancy() NSClassFromString(@NSVisualEffectView): true\n");
  } else {
     printf("--------VibrancyManager.mm ComputeSystemSupportsVibrancy() NSClassFromString(@NSVisualEffectView): false\n");
  }
  
  if (NSClassFromString(@"NSAppearance") && NSClassFromString(@"NSVisualEffectView")) {
     printf("--------VibrancyManager.mm ComputeSystemSupportsVibrancy() Both: true\n");
  } else {
     printf("--------VibrancyManager.mm ComputeSystemSupportsVibrancy() Both: false\n");
  }
...
VibrancyManager::SystemSupportsVibrancy()
{
  ...
  // Change to false to solve background problem of tolltip, menulist, columnpicker.
  // until now "true". supportsVibrancy = true.
