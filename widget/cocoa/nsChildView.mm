...
// [Big Sur Support] Leaves 2022.11 --------------------------------------------------
...
// [Big Sur Support] Leave 1-Lines 2022.11 -------------------------------------------
...
// [Big Sur Support] This Method Leave 2022.11 ---------------------------------------
...
// [Big Sur Support] Leave 1-Line 2022.11 --------------------------------------------
...
// [Big Sur Support] This interface Leave 2022.11 ------------------------------------
...
// [Big Sur Support] This Method Error 2022.11 ---------------------------------------
...
// [Big Sur Support] 6-lines Comments 2022.11 -----------------------------------------
...
// [Big Sur Support] Change 1-Line 2022.11 -------------------------------------------
...
// [Big Sur Support] 13-Lines Comments 2022.11 ---------------------------------------
...
// [Big Sur Support] 1-Line Change 2022.11 -------------------------------------------
...
// [Big Sur Support] 8-Lines Comments and 1-line Add 2022.11 -------------------------
//  if ([NSView focusView]) {
...
// [Big Sur Support] 5-Lines Comments and 3-Lines add 2022.11 ------------------------
...
nsChildView::PostRender(WidgetRenderingContext* aContext)
{
  ...
  UniquePtr<GLManager> manager(GLManager::CreateGLManager(aContext->mLayerManager));
// [Big Sur Support] 4-Lines Comments adn add 3-Lines 2022.11 ------------------------
//  gl::GLContext* gl = manager ? manager->gl() : aContext->mGL;
//  if (!gl) {
//    return;
//  }
...
// [Big Sur Support] 7-Lines Leaves 2022.11 ------------------------------------------
void
...
// [Big Sur Support] interface change(old 3 arguments) 2022.11 -----------------------
                                     ...
                                     uint32_t aAllowedDirections)
{
  ...
  if (mSwipeTracker) {
// [Big Sur Support] 1-Line old interface back 2022.11 -------------------------------
...
// [Big Sur Support] 1-Line Change and 4-Lines add 2022.11 ---------------------------
...
// [Big Sur Support] 4-Lines Comments 2022.11 ----------------------------------------
...
// [Big Sur Support] Add Start 2022.11 -----------------------------------------------
...
@end
;
// [Big Sur Support] Add End 2022.11 -------------------------------------------------
...
+ (void)initialize
{
  ...
  if (!initialized) {
    ...
    // that we can handle.
// [Big Sur Support] 2-Lines Change 2022.11 ------------------------------------------
//    NSArray* sendTypes = [[NSArray alloc] initWithObjects:NSPasteboardTypeString,NSPasteboardTypeHTML,nil];
//    NSArray* returnTypes = [[NSArray alloc] initWithObjects:NSPasteboardTypeString,NSPasteboardTypeHTML,nil];
...
{
// [Big Sur Support] 2,3,5 old interface Back 2022.11 --------------------------------
  [aView registerForDraggedTypes:[NSArray arrayWithObjects:NSFilenamesPboardType,
                                                           NSPasteboardTypeString,         // original code
                                                           NSPasteboardTypeHTML,           // original code
//                                                           NSStringPboardType,             // Big_sur support code
//                                                           NSHTMLPboardType,               // Big_sur support code
                                                           NSURLPboardType,
                                                           kPasteboardTypeFileURLPromise,  // original code
//                                                           NSFilesPromisePboardType,       // Big_sur support code
                                                           kWildcardPboardType,
                                                           kCorePboardType_url,
...
- (id)initWithFrame:(NSRect)inFrame geckoChild:(nsChildView*)inChild
{
  ...
  if ((self = [super initWithFrame:inFrame])) {
    mGeckoChild = inChild;
// [Big Sur Support] 1-Line Comment 2022.11 ------------------------------------------
//    mPendingDisplay = NO;
...
// [Big Sur Support] Comments Start 2022.11 ------------------------------------------
...
// [Big Sur Support] 6-Lines Add 2022.11 ---------------------------------------------
...
// [Big Sur Support] 1-Line Comment Back 2022.11 -------------------------------------
...
//  [mGLContext update];
// [Big Sur Support] Main Thread Exec 2022.11 ----------------------------------------
...
// [Big Sur Support] 4-Lines Leave 2022.11 -------------------------------------------
...
{
// [Big Sur Support] 4-Lines Comments and 6-Lines add 2022.11 ------------------------
...
// [Big Sur Support] 4-Lines Comments and 5-Lines add 2022.11 ------------------------
//  nsCocoaWindow* windowWidget = mGeckoChild ? mGeckoChild->GetXULWindowWidget() : nullptr;
//  if (windowWidget) {
...
// [Big Sur Support] 1-Line add 2022.11 ----------------------------------------------
...
// gecko to paint it
// [Big Sur Support] Method Name Chage 2022.11 ---------------------------------------
...
// [Big Sur Support] 2-Line Change 2022.11 -------------------------------------------
...
// [Big Sur Support] This Method Leaves 2022.11 --------------------------------------
- (BOOL)isUsingMainThreadOpenGL
{
...
// [Big Sur Support] 2-Method Leves 2022.11 ------------------------------------------
- (void)drawUsingOpenGL
{
...
// [Big Sur Support] 5-Lines Comments 2022.11 ----------------------------------------
...
// [Big Sur Support] 1-Method Leaves 2022.11 -----------------------------------------
...
// [Big Sur Support] 2-Method Leaves 2022.11 -----------------------------------------
...
// [Big Sur Support] This Method Leves 2022.11 ---------------------------------------
- (IAPZCTreeManager*)apzctm
{
...
// [Big Sur Support] 2-Lines Commnts and 1-Line add 2022.11 Back ---------------------
...
//      mDragService->FireDragEventAtSource(eDrag);
      ...
      if (!NS_SUCCEEDED(dragSession->GetCanDrop(&canDrop)) || !canDrop) {
        ...
        if (!sourceNode) {
// [Big Sur Support] 2-Lines Commnts and 1-Line add Back --------------------------------
...
// [Big Sur Support] 2-Lines Commenta and 1-Line add 2022.11 Back --------------------
          mDragService->EndDragSession(
            false, nsCocoaUtils::ModifiersForEvent([NSApp currentEvent]));
//          mDragService->EndDragSession(false);
        }
...
---------------------------------------------------------------------------------------- */
// [Big Sur Support] Method Change 2022.11 -------------------------------------------
...
// NSDraggingSource
// [Big Sur Support] Method add Start 2022.11 ----------------------------------------
- (void)draggedImage:(NSImage *)anImage endedAt:(NSPoint)aPoint operation:(NSDragOperation)operation
{
  ...
  if (mDragService) {
    ...
    mDragService->EndDragSession(true, 0);
...
// [Big Sur Support] Method add End 2022.11 ------------------------------------------
// [Big Sur Support] 3-Method Leaves 2022.11 -----------------------------------------
...
// [Big Sur Support] 1-Line Change 2022.11 -------------------------------------------
// #define IsSupportedType(typeStr) ([typeStr isEqualToString:NSPasteboardTypeString] || [typeStr isEqualToString:NSPasteboardTypeHTML])
...
// [Big Sur Support] 12-Lines Change Start 2022.11 -----------------------------------
...
// [Big Sur Support] Change Start End 2022.11 ----------------------------------------
...
// [Big Sur Support] 1-class add Start 2022.11 ---------------------------------------
...
@end
// [Big Sur Support] 1-class add End 2022.11 -----------------------------------------
...
#pragma mark -
// [Big Sur Support] This Line After Leaves Start 2022.11 ----------------------------
...
@end
// This Line After Leaves End 2022.11 ------------------------------------------------
...
@end
// [Big Sur Support] leave until the end 2022.11 -------------------------------------
#ifdef __LP64__
