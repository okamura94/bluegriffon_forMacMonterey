...
public:
    ...
    virtual nsresult        SetCursor(imgIContainer* aCursor, uint32_t aHotspotX, uint32_t aHotspotY) override;
...
// [Big Sur Support] 2 Argument Change 2022.11 ---------------------------------------
