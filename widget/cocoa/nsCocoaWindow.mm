                      ...
                      nsWidgetInitData* aInitData)
{
  ...
  if (mWindowType == eWindowType_sheet) {
     ...
     printf("--------nsCocoaWindow.mm Create() for Debug mWindowType Change: eWindowType_sheet -> eWindowType_dialog\n");
  }
...
// [Big Sur Support] Comment Start 2022.11 ------------------------------------------- 
...
//  }
// [Big Sur Support] Comment End 2022.11 --------------------------------------------- 
// [Big Sur Support] Start --------------------------------------------------------------
...
// Coordinates are desktop pixels
void nsCocoaWindow::DoResize(double aX, double aY,
...
// Coordinates are desktop pixels
void nsCocoaWindow::Resize(double aX, double aY,
                                    double aWidth, double aHeight,
                                    bool aRepaint)
{
...
nsresult nsCocoaWindow::SetCursor(imgIContainer* aCursor,
...
// [Big Sur Support] 8-Lines Comments ---------------------------------------------------
...
bool nsCocoaWindow::ExecuteNativeKeyBinding(NativeKeyBindingsType aType,
...
// [Big Sur Support] 1-Line Leaves 2022.11 -------------------------------------------
...
// [Big Sur Support] 4-Line Leaves 2022.11 -------------------------------------------
- (BOOL)FrameView__wantsFloatingTitlebar
{
  return NO;
}
...
// [Big Sur Support] 3-Lines Comment ----------------------------------------------------
...
// [Big Sur Support] Comment 8-Lines 2022.11 -----------------------------------------
...
// [Big Sur Support] 3-Lines Comments 2022.11 ----------------------------------------
